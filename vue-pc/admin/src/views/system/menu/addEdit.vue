    ...
    <el-dialog :title="title" :visible.sync="visible" width="500px" :before-close="handleClose">
        ...
        >
            ...
            <el-form-item label="排序：" prop="sort">
                <el-input-number v-model="formData.sort" :min="1" :max="10000" style="width: 350px"></el-input-number>
            </el-form-item>
...
export default {
    ...
    methods: {
        ...
        async submitData() {
            ...
            if (this.formData.id) {
                // 修改
                res = await this.$api.updateMenu(this.formData)
            } else {
                //新增
                res = await this.$api.addMenu(this.formData)
            }

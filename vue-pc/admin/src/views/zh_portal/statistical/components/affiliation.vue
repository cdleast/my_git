<template>
    <el-dialog title="所属机构" :visible.sync="visible" width="500px" :before-close="handleClose">
...
export default {
    ...
    methods: {
        ...
        handleNodeClick(data) {
            ...
            this.$emit('option-data', data, "affiliation")
        },
        ...
        handleClose() {
            ...
            this.remoteClose("affiliation") // 子组件传递的方法
        },
    }
};
</script>

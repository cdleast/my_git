    ...
    <div class="app-container">
        ...
        <el-form :inline="true" :model="query" size="mini">
            ...
            <el-form-item>
                ...
                <el-button v-if="!roleIds" icon="el-icon-circle-plus-outline" type="primary" @click="addData">新增</el-button>
                <!-- 用户管理点击设置角色弹窗才显示 -->
                <el-button v-if="roleIds" @click="handleUserRole" icon="el-icon-circle-plus-outline" type="success">设置角色</el-button>
            </el-form-item>
        </el-form>

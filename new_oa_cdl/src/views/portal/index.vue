x<template>
    <div class="portal">
        <el-row :gutter="20">
            <!-- 待办/待阅 -->
            <el-col :span="16" class="dbdy_tzgg">
                    ...
                    <el-tabs v-model="activeName1" @tab-click="handleClick">
                        <el-tab-pane label="待办" name="DAIBAN">
                            ...
                            >
                                ...
                                ></el-table-column>
                                <el-table-column prop="SEND_USER_CODE__NAME" label="发送者"></el-table-column>
                                <el-table-column
                                    prop="SEND_DEPT_NAME"
                                    show-overflow-tooltip
                                    label="所在部门"
                        ...
                        <el-tab-pane label="待阅" name="DAIYUE">
                            ...
                            >
                                ...
                                ></el-table-column>
                                <el-table-column prop="SEND_USER_CODE__NAME" label="发送者"></el-table-column>
                                <el-table-column prop="SEND_DEPT_NAME" label="所在部门"></el-table-column>
                                <el-table-column
                                    prop="TODO_CODE_NAME"
                                    label="代办类型"
                                    show-overflow-tooltip
                        ...
                        <el-tab-pane label="未结" name="WEIJIE">
                            ...
                            >
                                <el-table-column
                                    ...
                                    show-overflow-tooltip
                                ></el-table-column>
                                <el-table-column prop="S_USER__NAME" label="拟稿人"></el-table-column>
                                <el-table-column prop="S_TDEPT__NAME" label="拟稿部门"></el-table-column>
                                <el-table-column
                                    prop="SERV_NAME"
                                    label="单据类型"
                                    show-overflow-tooltip
                        ...
                        <el-tab-pane label="提醒" name="TIXING">
                            ...
                            >
                                <el-table-column
                                    ...
                                    show-overflow-tooltip
                                ></el-table-column>
                                <el-table-column prop="SEND_USER__NAME" label="发送者"></el-table-column>
                                <el-table-column prop="S_DEPT__NAME" label="所在部门"></el-table-column>
                                <el-table-column
                                    prop="SERV_NAME"
                                    label="单据类型"
                                    show-overflow-tooltip
                ...
                <div class="grid-content">
                    <el-card class="box-card">
                        ...
                        <div v-for="(item,index) in tableTongZhi" :key="index" class="item">
                            ...
                            <span class="item_right">{{item.NEWS_TIME | comverTime('YYYY-MM-DD日')}}</span>
                        </div>
                    </el-card>
                </div>
            </el-col>
...
.items_badge /deep/ .el-badge__content {
    width: 22px;
    height: 22px;
    line-height: 22px;
    padding: 0;

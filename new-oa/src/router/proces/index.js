export default [
    {
        path: '/proces', meta: { title: '流程中心' }, name: 'proces', component: () => import('@/views/proces'), children: [
            ...
            { path: '/baoxiaoguanli', meta: { title: '报销管理', activeParent: '/proces', activeChild: '/baoxiaoguanli' }, name: 'baoxiaoguanli', component: () => import('@/components/proces/baoxiaoguanli') },
